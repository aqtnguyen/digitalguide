...
function AddPoiImg() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/img/poi/${id}`)
      .then((response) => setImgObject(response.data))
  ...
  return (
    <div className="addTourImgContainer">
      ...
      <h1>Add additional POI Images</h1>
      <AlertBar
        ref={alertBarRef}
